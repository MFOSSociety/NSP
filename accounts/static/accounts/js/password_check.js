function checkPass() {
    ...
    if (acheck.test(a)) {
        ...
        document.getElementById("message").innerHTML = "Password must be at least 8 in lenth and contain  one special character,number,lower case and upper case alphabet";
        return false;
    }
}

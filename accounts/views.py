...
def ProfileView(request):
    ...
    # filter()/first() helps in getting rid of _meta error at last of the statement
    users = users.filter(userprofile__ratings__isnull = False).order_by('userprofile__ratings').first()
    args = {'user': users}
